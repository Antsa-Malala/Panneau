...
public class Unite {
    ...
    public void setCategorie(String idarticle) {
        this.categorie = idarticle;
    }
    public Unite(int idunite, String nomUnite, double reference, String categorie) throws Exception{
    ...
    public Unite(String nomUnite, String categorie) throws Exception{
        this.setNomUnite(nomUnite);
        this.setCategorie(categorie);
    }
...
/*  */    
    public static Unite getById(int idUnite,Connection con) throws Exception
    {
    ...
    public Unite getUniteReference(Connection con) throws Exception
    {
        ...
        try{
            ...
            String requete = "select * from unite where categorie='"+this.getCategorie()+"' and reference=1";
    ...
    public Unite getUnite(Connection con) throws Exception
    {
        ...
        try{
            ...
            String requete = "select * from unite where categorie='"+this.getCategorie()+"' and nomUnite='"+this.getNomUnite()+"'";
            st = con.createStatement();
            res = st.executeQuery(requete);
            while(res.next())
            {
